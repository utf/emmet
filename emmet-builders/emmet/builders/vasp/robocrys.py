...
class RobocrysBuilder(MapBuilder):
    def __init__(self, materials, robocrys, **kwargs):
        """
        Runs robocrystallographer.

        Args:
            materials (Store): Store of materials documents.
            robocrys (Store): Store of condensed structure and text structure
            description.
            **kwargs: Keyword arguments that will get passed to the builder super
            method.
        """
        ...
        super().__init__(
            source=materials, target=robocrys, projection=["structure"], **kwargs
        )
